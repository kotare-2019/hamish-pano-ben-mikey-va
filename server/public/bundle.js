...
function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    key: "renderBeer",
    value: function renderBeer(beers) {
      this.setState({
        beers: beers || []
      });
    }
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
!(function webpackMissingModule() { var e = new Error("Cannot find module 'google-map-react'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
/*#__PURE__*/
function (_Component) {
  _inherits(PubsMap, _Component);

  function PubsMap(props) {
    var _this;

    _classCallCheck(this, PubsMap);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(PubsMap).call(this, props));
    console.log(props);
    _this.map = {
      center: {
        lat: -41.2962181,
  ...
  _createClass(PubsMap, [{
    ...
    value: function render() {
      return (// Important! Always set the container height explicitly
        ...
        }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(!(function webpackMissingModule() { var e = new Error("Cannot find module 'google-map-react'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()), {
          bootstrapURLKeys: {
            key: 'AIzaSyAvfWB1UvnfnIYv85YHcVaA7cvE4jwtzJk'
          },
...
/* harmony default export */ __webpack_exports__["default"] = (PubsMap);
